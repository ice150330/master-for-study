 ...
 * 阶段 0 中弹窗为 UI 占位（指针事件穿透），三选项动作在阶段 1 接入会话树后接上。
 */
export function Term({
  ...
  return (
    <span className="group relative inline-flex">
      ...
      {/* 悬停弹窗（浅色卡片，与深底形成对比） */}
      <span className="pointer-events-none absolute bottom-full left-0 z-10 mb-2 w-60 rounded-2xl bg-card p-3 opacity-0 shadow-xl transition-opacity duration-150 group-hover:opacity-100">
