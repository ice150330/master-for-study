      ...
      <div className="flex items-center gap-2">
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="mt-0.5 flex items-center gap-1.5 text-[10px] text-muted">
            ...
            {item.mainline ? <span className="rounded-[2px] border border-dashed border-accent px-1 text-[9px] leading-4 text-accent-foreground">主线</span> : null}
          </span>
        </span>
      </div>
